...
class User:
    ...
    def save(cls, formulario):
        ...
        result = connectToMySQL('recetas_g1').query_db(query, formulario) #1 - Insert recibe id
    ...
    def valida_usuario(formulario):
        ...
        results = connectToMySQL('recetas_g1').query_db(query, formulario)
        if len(results) >= 1:
    ...
    def get_by_id(cls, formulario):
        ...
        result = connectToMySQL('recetas_g1').query_db(query, formulario) #Select recibe lista
        user = cls(result[0])
        return user
